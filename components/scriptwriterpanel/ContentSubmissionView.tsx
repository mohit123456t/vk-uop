...
const ContentSubmissionView = () => {
    const [uploadedFiles, setUploadedFiles] = useState([
        { id: 1, name: 'script_draft.docx', size: '5MB', status: 'draft', uploadedAt: '2023-10-01' },
        { id: 2, name: 'final_script.pdf', size: '8MB', status: 'submitted', uploadedAt: '2023-10-02' },
    ]);
    ...
    return (
        <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-semibold mb-4">Upload Script Content</h2>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer">
                        ...
                        <p className="text-sm text-gray-500">DOCX, PDF, TXT, RTF up to 50MB</p>
                    </label>
                </div>
            </div>

            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-semibold mb-4">Submitted Scripts</h2>
