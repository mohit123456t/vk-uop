...
const ContentSubmissionView = () => {
    const [uploadedFiles, setUploadedFiles] = useState([
        { id: 1, name: 'campaign_assets.zip', size: '15MB', status: 'draft', uploadedAt: '2023-10-01' },
        { id: 2, name: 'brand_guidelines.pdf', size: '5MB', status: 'submitted', uploadedAt: '2023-10-02' },
    ]);
    ...
    return (
        <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-semibold mb-4">Upload Campaign Content</h2>
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    <input
                        ...
                        className="hidden"
                        id="file-upload"
                        accept=".zip,.pdf,.jpg,.png,.mp4,.docx"
                    />
                    <label htmlFor="file-upload" className="cursor-pointer">
                        ...
                        <p className="text-sm text-gray-500">ZIP, PDF, JPG, PNG, MP4, DOCX up to 100MB</p>
                    </label>
                </div>
            </div>

            <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-xl font-semibold mb-4">Submitted Campaign Content</h2>
