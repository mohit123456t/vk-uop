...
import AssignedTasksPanel from './components/videoeditorpanel/AssignedTasksPanel';
      ...
      <div className="relative min-h-screen">
        ...
        <Routes>
          ...
          <Route path="/script-writer" element={
            <PrivateRoute>
              <ScriptWriterPanel onNavigate={() => {}} />
            </PrivateRoute>
          } />
          <Route path="/video-editor" element={
            <PrivateRoute>
              <VideoEditorPanel onNavigate={() => {}} />
            </PrivateRoute>
          } />
          <Route path="/video-editor/assigned-tasks" element={
            <PrivateRoute>
              <AssignedTasksPanel />
            </PrivateRoute>
          } />
          <Route path="/thumbnail-maker" element={
            <PrivateRoute>
              <ThumbnailMakerPanel onNavigate={() => {}} />
            </PrivateRoute>
          } />
